...
@Component
public class LoginAttemptsEventMetrics {

  private static final String FAM_LOGIN_ATTEMPT_REQUEST_ACTION_VALUE = "fam_login_attempt_request";

  @Autowired
  private MeterRegistry registry;

  public void incrementFAMLoginAttemptRequestsToTMASuccess() {
    registry.counter(DOWNSTREAM_REQUEST_SUCCESS, Tags.of(PAYMENT_TYPE_NAME_TAG, EMPTY_VALUE,
        ...
        FAM_LOGIN_ATTEMPT_REQUEST_ACTION_VALUE)).increment();
  }

  public void incrementFAMLoginAttemptRequestsToTMAFailed() {
    registry.counter(DOWNSTREAM_REQUEST_FAILED, Tags.of(PAYMENT_TYPE_NAME_TAG, EMPTY_VALUE,
        DOWNSTREAM_SERVICE_NAME_TAG, DOWNSTREAM_SERVICE_TRANSACTIONMONITORING_NAME, GENERATED_BY_ACTION_TAG,
        FAM_LOGIN_ATTEMPT_REQUEST_ACTION_VALUE, ALERT_TAG, ALERT_YES)).increment();
  }
  ...
  public void initializeCounter() {
    registerCounterInstance(DOWNSTREAM_REQUEST_FAILED, PAYMENT_TYPE_NAME_TAG, EMPTY_VALUE,
        ...
        ALERT_TAG, ALERT_YES, GENERATED_BY_ACTION_TAG, FAM_LOGIN_ATTEMPT_REQUEST_ACTION_VALUE);

    registerCounterInstance(DOWNSTREAM_REQUEST_SUCCESS, PAYMENT_TYPE_NAME_TAG, EMPTY_VALUE,
        DOWNSTREAM_SERVICE_NAME_TAG, DOWNSTREAM_SERVICE_TRANSACTIONMONITORING_NAME, GENERATED_BY_ACTION_TAG,
        FAM_LOGIN_ATTEMPT_REQUEST_ACTION_VALUE);
  }
