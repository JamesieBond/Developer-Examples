...
@Component
public class IdentityAccountResetEventMetrics {

  private static final String FAM_IDACCOUNT_RESET_REQUEST_ACTION_VALUE = "fam_idaccount_reset_request";
  @Autowired
  private MeterRegistry registry;

  public void incrementFAMIdAccountResetRequestsToTMASuccess() {
    registry.counter(DOWNSTREAM_REQUEST_SUCCESS, Tags.of(PAYMENT_TYPE_NAME_TAG, EMPTY_VALUE,
        ...
        FAM_IDACCOUNT_RESET_REQUEST_ACTION_VALUE)).increment();
  }

  public void incrementFAMIdAccountResetRequestsToTMAFailed() {
    registry.counter(DOWNSTREAM_REQUEST_FAILED, Tags.of(PAYMENT_TYPE_NAME_TAG, EMPTY_VALUE,
        DOWNSTREAM_SERVICE_NAME_TAG, DOWNSTREAM_SERVICE_TRANSACTIONMONITORING_NAME, GENERATED_BY_ACTION_TAG,
        FAM_IDACCOUNT_RESET_REQUEST_ACTION_VALUE, ALERT_TAG, ALERT_YES)).increment();
  }
  ...
  public void initializeCounter() {
    registerCounterInstance(DOWNSTREAM_REQUEST_FAILED, PAYMENT_TYPE_NAME_TAG, EMPTY_VALUE,
        ...
        ALERT_TAG, ALERT_YES, GENERATED_BY_ACTION_TAG, FAM_IDACCOUNT_RESET_REQUEST_ACTION_VALUE);

    registerCounterInstance(DOWNSTREAM_REQUEST_SUCCESS, PAYMENT_TYPE_NAME_TAG, EMPTY_VALUE,
        DOWNSTREAM_SERVICE_NAME_TAG, DOWNSTREAM_SERVICE_TRANSACTIONMONITORING_NAME, GENERATED_BY_ACTION_TAG,
        FAM_IDACCOUNT_RESET_REQUEST_ACTION_VALUE);
  }
