...
@Component
public class IndividualPartyEventMetrics {

  @Autowired
  private MeterRegistry registry;

  private static final String FAM_INDIVIDUAL_PARTY_REQUEST_ACTION_VALUE = "fam_individual_party_request";

  public void incrementFAMIndividualPartyRequestsToTMASuccess() {
    registry.counter(DOWNSTREAM_REQUEST_SUCCESS, Tags.of(PAYMENT_TYPE_NAME_TAG, EMPTY_VALUE,
        ...
        FAM_INDIVIDUAL_PARTY_REQUEST_ACTION_VALUE)).increment();
  }

  public void incrementFAMIndividualPartyRequestsToTMAFailed() {
    registry.counter(DOWNSTREAM_REQUEST_FAILED, Tags.of(PAYMENT_TYPE_NAME_TAG, EMPTY_VALUE,
        DOWNSTREAM_SERVICE_NAME_TAG, DOWNSTREAM_SERVICE_TRANSACTIONMONITORING_NAME, GENERATED_BY_ACTION_TAG,
        FAM_INDIVIDUAL_PARTY_REQUEST_ACTION_VALUE, ALERT_TAG, ALERT_YES)).increment();
  }
  ...
  public void initializeCounter() {
    registerCounterInstance(DOWNSTREAM_REQUEST_FAILED, PAYMENT_TYPE_NAME_TAG, EMPTY_VALUE,
        ...
        ALERT_TAG, ALERT_YES, GENERATED_BY_ACTION_TAG, FAM_INDIVIDUAL_PARTY_REQUEST_ACTION_VALUE);

    registerCounterInstance(DOWNSTREAM_REQUEST_SUCCESS, PAYMENT_TYPE_NAME_TAG, EMPTY_VALUE,
        DOWNSTREAM_SERVICE_NAME_TAG, DOWNSTREAM_SERVICE_TRANSACTIONMONITORING_NAME, GENERATED_BY_ACTION_TAG,
        FAM_INDIVIDUAL_PARTY_REQUEST_ACTION_VALUE);
  }
