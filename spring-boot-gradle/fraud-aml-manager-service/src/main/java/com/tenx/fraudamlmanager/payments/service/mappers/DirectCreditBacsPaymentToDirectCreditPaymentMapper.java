...
@Mapper
public interface DirectCreditBacsPaymentToDirectCreditPaymentMapper {
    DirectCreditBacsPaymentToDirectCreditPaymentMapper MAPPER = Mappers.getMapper(DirectCreditBacsPaymentToDirectCreditPaymentMapper.class);
    ...
    DirectCreditBacsPayment toDirectCreditPayment(DirectCreditPayment directCreditPayment);
