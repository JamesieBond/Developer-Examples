...
@NoArgsConstructor
@AllArgsConstructor
public class DirectDebitBacsPaymentRequestV2 {

    @Valid
    @NotNull
    @ApiModelProperty(required = true)
    private AccountDetailsDirectDebitRequestV2 creditorAccountDetails;
    ...
    @NotNull
    @ApiModelProperty(required = true)
    private AccountDetailsDirectDebitRequestV2 debtorAccountDetails;
    ...
    @NotNull
    @ApiModelProperty(required = true)
    private PaymentAmountRequestDirectDebitV2 amount;
