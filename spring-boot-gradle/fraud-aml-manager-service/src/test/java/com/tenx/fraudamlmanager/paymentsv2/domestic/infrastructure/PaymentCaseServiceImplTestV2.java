package com.tenx.fraudamlmanager.paymentsv2.domestic.infrastructure;
...
import com.tenx.fraudamlmanager.paymentsv2.cases.infrastructure.PaymentCaseServiceImplV2;
...
public class PaymentCaseServiceImplTestV2 {
    ...
    @Test
    public void checkSavePaymentEventDomesticOut() {

        DomesticOutPaymentV2 domesticOutPaymentV2 = new DomesticOutPaymentV2(
          ...
          new AccountDetailsV2("Test", "123", "Test", "abc", "Test", "IbanTest"),
            "debitor name",
            "TEst",
            new PaymentAmountV2("EUR", 30,
                "EUR", 30),
            "123key",
            new Date(),
                new BalanceBeforeV2("GBP", 500.00,
                        "GBP", 500.00),
                new Date(),
                "Review", "Reference Test", "test domestic notes",
                new ArrayList<String>(), true, "456key", new HashMap<>(), "paymentType");
        ...
        paymentCaseEntity.setTransactionId("123key");
        ...
        given(caseAssemblerV2.assembleCase(domesticOutPaymentV2)).willReturn(newCase);
        paymentCaseServiceImplV2.createSavePaymentCase(domesticOutPaymentV2);
